...
public class VillainResourceTest {
    ...
    private static final String UPDATED_NAME = "Super Chocolate (updated)";
    ...
    private static final String DEFAULT_POWERS = "does not eat pain au chocolate";
    private static final String UPDATED_POWERS = "does not eat pain au chocolate (updated)";
    ...
    void shouldRemoveAnItem() {
        ...
        List<Villain> villains = given().get("/api/villains")
            .then()
            .statusCode(OK.getStatusCode())
            .header(CONTENT_TYPE, JSON)
            .extract().body().as(getVillainTypeRef());
